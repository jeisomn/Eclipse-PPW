...
a persistence unit "demo64PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "demo64/pom.xml":
...
artifact ("demo64.war") is already built. You can build
